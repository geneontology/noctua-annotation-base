...
// -----------------------------------------------------------------------------------------------------
// @ NOCTUA TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `noctua.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `noctua.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--noctua-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--noctua-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
